...
#       OutputFn( lDiseaseType , GeneName , lRet )   
# # ======================================================================================================

# # ======================================================================================================
# def HeaderTsv( DiseaseType ):
#   dest.write( f"Disease-type\tGene\t" )
#   dest.write( f"Mut-count\tMut-mean\tMut-mean-error\tMut-std.dev\t" )
#   dest.write( f"WT-count\tWT-mean\tWT-mean-error\tWT-std.dev\t" )
#   dest.write( f"Mut mean/WT mean\terror(Mut mean/WT mean)\t" )
#   dest.write( f"log_1.5(ratio)\terror(log_1.5(ratio))\t" )
#   dest.write( f"t-score\tp-value\tneg log_10(p-value)\n" ) # Write headers  

# def OutputTsv( DiseaseType , GeneName , aStats ):
#   dest.write( f"{DiseaseType}\t{GeneName}\t" )
...
# def OutputXlsx( DiseaseType , GeneName , aStats ):
...
def ExportXlsx( Data ): 
  ...
  lFile = f".cache/Comutation.{MutationOfInterest}.{file_hash.hexdigest()}.pkl.bz"
  ...
  for lDiseaseType , lData in Data.items():
