...
with open( args.src , "rb" ) as src , open( args.dest , "w" ) as dest:   # Open the destination tsv and call the file-handle 'dest'
  lCases = pickle.load( src )                                            # Load the GDC data from the formatted tarball as a dictionary of CaseId strings and Case objects
