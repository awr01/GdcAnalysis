...
def ForEachClass( Class , Cases , index ):
  ...
  lMut , lWt =  FlattenTpmUnstranded( lMut , DRG2 ) , FlattenTpmUnstranded( lWt , DRG2 ) 
...
def Finally( Data ):
  ...
  # Fill the plots 
  for (Classification , lData ) , ax1 in tqdm.tqdm( list( zip( Data.items() , fig.axes ) ) , ncols=Ncol , desc=f"Drawing Box plots" ):
...
LoadAndClassify( args.src , lambda aCase: str( aCase.DiseaseType ) , ForEachClass , Finally )    
# ======================================================================================================
